...
var studentAge = 15
var studentYear = 11
var greeting = "There is a young \(studentAge) year old boy called \(studentName). He is in year \(studentYear) at \(school). \(studentName) does \(schoolHours) hours of school work every day and then he goes home."
print(greeting)

studentName = "Mr Beast"
studentYear = 6
studentAge = 27
...
let dog_age = 6.0
let early_years = 10.5 * 2.0
let later_years = (dog_age - 2) * 4.0
let human_years = early_years + later_years
print(dog_age)
print(human_years)
